<section class="content-header">
  <h1>LIST SURVEY SP KALTARA</h1>
  <ol class="breadcrumb">
    <li><a href="<?php echo site_url('home/get_survey_sp_kaltara'); ?>"><i class="fa fa-list"></i> SP Kaltim</a></li>
...
<div class="box-body">
  ...
  <table id="myTable" class="table table-striped" cellspacing="0" style="font-size: 12px;">
    <thead>
    <form name="cari" action="<?php echo site_url() ?>home/get_survey_sp_kaltara" method="GET">
          <tr>
              ...
              <th width="160" colspan="4">
                  ...
                  <div class="btn-group">  
                    <a class="btn btn-success" href="<?php echo site_url() ?>home/export_excel_sp_kaltara"><i class="fa fa-file-excel-o"></i> Export to Excel</a>
                  </div>
              </th> 
          </tr>
      </form> 
  ...
  ?>
    ...
    ?>
      <tr>
        <td><a href="<?php echo site_url(); ?>home/view_sp_kaltara/<?php echo $baris->survey_id; ?>"><?php echo $no;?></a></td>
        ...
        <td>
        <a href="<?php echo site_url() ?>home/delete_survey_sp_kaltara/<?php echo $baris->survey_id;?>" class="btn btn-xs btn-danger" onClick='return confirm("Anda yakin ingin menghapus data ini?")'><span class="glyphicon glyphicon-trash"></span></a>                   
        </td>
      </tr>
    <?php
      $no++;
    ...
    ?>
    <tr class="success">
      <th colspan="9">Total Survey : <span class="badge"><?php echo $total->row()->total;?></span></th>
    </tr>
    </tbody> 
