<section class="content-header">
  <h1>LIST SURVEY TP TANGERANG</h1>
  <ol class="breadcrumb">
  <li><a href="<?php echo site_url('home/get_survey_tp_tgr'); ?>"><i class="fa fa-list"></i>  TP Tangerang</a></li>
...
<div class="box-body">
  ...
  <table id="myTable" class="table table-striped" cellspacing="0" style="font-size: 12px;">
    <thead>
    <form name="cari" action="<?php echo site_url() ?>home/get_survey_tp_tangerang" method="GET">
          <tr>
              ...
              <th width="160" colspan="4">
                  ...
                  <div class="btn-group">  
                    <a class="btn btn-success" href="<?php echo site_url() ?>home/export_excel_tp_tgr"><i class="fa fa-file-excel-o"></i> Export to Excel</a>
                  </div>
              </th> 
          </tr>
      </form>  
    ...
    ?>
      <tr>
        <td><a href="<?php echo site_url(); ?>home/view_tp_tangerang/<?php echo $baris->survey_id; ?>"><?php echo $no;?></a></td>
        ...
        <td>
        <a href="<?php echo site_url() ?>home/delete_survey_tp_tangerang/<?php echo $baris->survey_id;?>" class="btn btn-xs btn-danger" onClick='return confirm("Anda yakin ingin menghapus data ini?")'><span class="glyphicon glyphicon-trash"></span></a>                   
        </td>
      </tr>
    <?php
      $no++;
